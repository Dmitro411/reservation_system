# Generated by Django 5.2.6 on 2025-09-03 15:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('in_progress', 'В обробці'), ('confirmed', 'Підтверджено'), ('canceled', 'Скасовано')], default='in_progress', max_length=20, verbose_name='Статус:')),
                ('comment', models.CharField(max_length=100, verbose_name='Коментар:')),
                ('created_at', models.DateTimeField(auto_now=True)),
                ('updated_at', models.DateTimeField(auto_now_add=True)),
                ('client', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='bookings', to='booking.client', verbose_name='Клиєнт')),
